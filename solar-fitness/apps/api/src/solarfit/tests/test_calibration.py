...
def calibration_session_factory(sqlite_engine, monkeypatch):
    ...
    points repositories.calibration.get_session at it."""
    ...
    monkeypatch.setattr(calibration, "get_session", lambda: session_local())
...
def mock_site_and_cache(monkeypatch, make_site):
    ...
    monkeypatch.setattr(calibration.sites_repo, "get", lambda site_id: site)
...
def test_record_field_survey_unknown_site_still_records(calibration_session_factory, monkeypatch):
    ...
    monkeypatch.setattr(calibration.sites_repo, "get", lambda site_id: None)
